...
public class SequenceActivity extends Activity{
	...
	public void startButton(View view){
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.sequence_text_view, arrayList);
	    ...
	    gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
	        public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
	            ...
	            if((arrayPos) == numbers.length){
	        		...
	        		float newTime = (currentTime.toMillis(false) - startTime.toMillis(false))/1000;
